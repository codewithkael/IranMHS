...
public class hamahangiadapter extends RecyclerView.Adapter<hamahangiadapter.ViewHolder> {

    private List<hamahangicls> mData;
    private DataBase db;
    ...
    public hamahangiadapter(Context context, List<hamahangicls> data, Activity pActivity, String clid, String plid) {
    ...
    public void updatedb(){
        mData = db.gethamahangi(cluid,plnum);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.hamitem, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final hamahangicls data = mData.get(position);


        holder.titletxt.setText(  "نوبت تماس " +  " "+ String.valueOf(position+1));
...
//
        ...
        holder.nesbat.setText(data.nesbat);
        holder.noe.setText(data.type);
        holder.vaziat.setText(data.natije);
//
        ...
        holder.hazfbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    db.runquery("delete from  tblhamahangi  where hamid = " + String.valueOf( data.hamid)  );
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
     ...
     //   Button mapbtn;
        ...
        ViewHolder(View itemView) {
            ...
            noe = itemView.findViewById(R.id.textView84);
            nesbat = itemView.findViewById(R.id.textView81);
            vaziat = itemView.findViewById(R.id.textView841);
