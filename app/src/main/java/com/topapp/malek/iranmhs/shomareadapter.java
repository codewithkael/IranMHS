...
public class shomareadapter extends RecyclerView.Adapter<shomareadapter.ViewHolder> {

    private List<shomaretamascls> mData;
    private DataBase db;
    ...
    public shomareadapter(Context context, List<shomaretamascls> data, Activity pActivity, String clid, String plid) {
    ...
    public void updatedb(){
        mData = db.getshomaretamas(cluid,plnum);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = mInflater.inflate(R.layout.shomareitem, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final shomaretamascls data = mData.get(position);


        holder.titletxt.setText(  "شماره تماس  " +  " "+ String.valueOf(position+1));
...
//
        ...
        holder.shomare.setText(data.shomare);
        holder.noe.setText(data.noee);
        holder.vaziat.setText(data.tozihat);
//
        ...
        holder.hazfbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    db.runquery("delete from  tblshomaretamas  where shomareid = " + String.valueOf( data.shomareid)  );
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
     ...
     //   Button mapbtn;
        ...
        ViewHolder(View itemView) {
            ...
            noe = itemView.findViewById(R.id.textView8);
            shomare = itemView.findViewById(R.id.textView84);

            vaziat = itemView.findViewById(R.id.textView81);
